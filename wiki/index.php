...
<head>
    ...
    <title>Wiki | Mintank Bombom</title>
    <meta name="description" content="Oyunumuz hakkında detayları görebilirsiniz.">
...
<?php 
	...
	$data = http_build_query(array('sec' => ')r5r9r(>UB`oFNF2}4Lp'));
     ...
     $url = 'http://apps.mintank.com/component/wiki.php';
