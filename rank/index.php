...
<head>
    ...
    <title>Top 20 | Mintank Bombom</title>
    <meta name="description" content="Oyuna bakiyeyi buradan yükleyebilirsiniz">
    <meta name="author" content="_nK">
    <link rel="icon" type="image/png" href="https://minttank.b-cdn.net/assets/images/favicon.png">
...
<div class="row vertical-gap">
     ...
     $url = 'http://apps.mintank.com/component/ranklist.php';
